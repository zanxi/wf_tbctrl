...
namespace WpfApp_09_Style_TabControl.DAL
{
        public class Document
        {
            public static int DocumentAdd(Model.Document documentinfo)
            {
                ...
                return WpfApp_09_Style_TabControl.TestWFDesigner.SqlHelper.ExecuteProcess("pro_Document_Add", pars);
            }
            ...
            public static int DocumentDel(string ID)
            {
                ...
                pars[0].Value = ID;
            return WpfApp_09_Style_TabControl.TestWFDesigner.SqlHelper.ExecuteProcess("pro_Document_Del", pars);
            }
            ...
            public static int PublicDocument(string ID)
            {
                SqlParameter[] pars = new SqlParameter[] { new SqlParameter("@ID", SqlDbType.Int) };
                pars[0].Value = ID;
            return WpfApp_09_Style_TabControl.TestWFDesigner.SqlHelper.ExecuteProcess("pro_Document_Public", pars);
            }
            ...
            public static int DocumentUpdate(Model.Document documentinfo)
            {
                ...
                pars[7].Value = documentinfo.FlowInstranceID;
            return WpfApp_09_Style_TabControl.TestWFDesigner.SqlHelper.ExecuteProcess("pro_Document_Update", pars);
            }
            ...
            public static int DocumentEndStep(Guid FlowID, string result)
            {
                ...
                pars[0].Value = FlowID;
                pars[1].Value = result;
            return WpfApp_09_Style_TabControl.TestWFDesigner.SqlHelper.ExecuteProcess("pro_Document_EndStep", pars);
            }
            ...
            public static int DocumentStep(Guid FlowID, string StepID)
            {
                ...
                pars[0].Value = FlowID;
                pars[1].Value = StepID;
            return WpfApp_09_Style_TabControl.TestWFDesigner.SqlHelper.ExecuteProcess("pro_Document_Step", pars);
            }
        }
    }
